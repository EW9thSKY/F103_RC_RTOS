...
/* 循迹比例控制 ---------------------------------------------------*/
#define TRACK_BASE_SPEED  50    /* 基准速度 (0~100%)               */
#define TRACK_KP          12    /* 比例增益（越大转向越激进）        */
#define TRACK_LOST_SPEED  25    /* 丢线搜索速度                    */
#define TRACK_MIN_SPEED   20    /* 最低钳位速度                    */
#define TRACK_MAX_SPEED   80    /* 最高钳位速度                    */
